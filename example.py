...
if __name__ == "__main__":
    ...
    trainer.train(max_steps=500,
                  verbose=10,                       # Sample from the model each 50 steps
                  ...
                  save_each_n_steps=100,            # Save the state each 100 steps
